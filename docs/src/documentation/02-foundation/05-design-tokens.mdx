---
title: Design tokens
excerpt: Design tokens store visual design attributes. They help us make our UI more consistent and we support custom themes.
---

import Tips from "@kiwicom/orbit-components/lib/icons/Tips";
...
We are also able to generate a JSON file,
which will allow us to transform this type of file into different ones.
