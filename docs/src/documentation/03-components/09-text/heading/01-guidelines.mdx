...
<FigmaFile
  ...
  node="0%3A237"
  alt="1st level heading: opens every page; 2nd level heading: opens sections with grouped content; 3rd level heading: following the content hierarchy when more structure is needed."
/>
...
Don't skip around in the hierarchy or you'll confuse users.
...
<Guidelines type="do" title="Respect the hierarchy">


<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="62%3A5"
  alt="Headings with (from the top) and h1, an h2, some text, an h2, and some text."
/>
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="61%3A0"
  alt="Headings with (from the top) and h1, an h4, some text, an h3, and some text."
/>
...
but remember that [not everyone will be able to see it](/foundation/accessibility/).
...
<ReactExample name="Heading types" />
...
<ReactExample name="Heading inverted" />

### Use only a single color

While you might be tempted to make your headings stand out even more by using various colors,
resist the temptation.
Trust the visual style to make it clear what is important and what isn't.

In particular, do not use our product colors (such as <InlineToken value="paletteProductNormal" alternateName />)
...
<Guidelines type="do" title="Use heading color">


<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="63%3A0"
  alt="A heading in the middle of text with everything in the same color."
/>
<FigmaFile
  file="fannvRpkOJK6uxxT33EKaa"
  node="64%3A6"
  alt="A heading in the middle of text with the heading in green."
/>
