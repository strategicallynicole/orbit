...
If you'd like to have an action, consider an [alert](/components/information/alert-message/) or a [button](/components/action/button/) instead.
...
by giving it a label for people who won't see the icon.
...
To keep the UI uncluttered, you can choose one that supports [progressive disclosure](/guides/progressive-disclosure/),
...
They're useful when the information is not so important to the user's main flow.
...
but isn't critical.
They are associated with negative emotions
