...
- You have many sections with little information in each---use a [table](/components/interaction/table/).
...
This helps divide your content into logical sections and make it clear what is related.
