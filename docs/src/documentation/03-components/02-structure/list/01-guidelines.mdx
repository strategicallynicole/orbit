...
- There are choices connected to the information---use [checkboxes](https://orbit.kiwi/components/checkbox/
  or [radio](https://orbit.kiwi/components/radio/) buttons to enable interaction.
- You have complex structures with choices--- use [list choices](https://orbit.kiwi/components/listchoice/).
...
They are not designed to emphasize details.
So don't use them when you only have one item to set off from surrounding text.

<Guidelines type="do" title="Not for emphasis">
