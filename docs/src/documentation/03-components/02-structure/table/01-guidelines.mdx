...
<ReactExample name="Table" />

## When to use

- To present tabular information with a clear, repeating sturcture.
...
<ReactExample name="Table accessibility" />
...
Users will get slowed down in scanning if there's too much information at once.
...
<Guidelines type="do" title="Short headers">
...
it helps if it is all presented in the same way.
...
<ReactExample name="Table colors" />
