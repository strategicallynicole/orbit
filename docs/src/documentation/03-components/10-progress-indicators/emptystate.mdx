...
Remember that an empty state is not a desired outcome,
...
remember that we keep our tone [more serious in stressful situations](/for-kiwi/content/voice-tone/empathetic/#keep-tone-serious-in-stressful-situations).
...
<Guidelines type="do" title="Guide, don't blame">
