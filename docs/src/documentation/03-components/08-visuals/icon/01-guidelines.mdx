...
Some icons (like [plus \[+\]](#plus) and [close \[×\]](#close))
...
This creates an expectation that clicking them will do something,
...
When creating lists and other repeated structures, make sure to use icons that seem visually consistent. For example, to show steps taken and not, use [check-circle](#check-circle) and [close-circle](#close-circle) to present similar visual cues.
...
Not everyone will be able to see your carefully selected icon,
...
<ReactExample name="Icon accessibility" />
