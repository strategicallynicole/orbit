...
<ReactExample name="CarrierLogo accessibility" />
...
With one logo, by default it'll occupy the entire space.
...
With two logos, they'll be in the top left and bottom right.
...
<ReactExample name="CarrierLogo multiple" />
