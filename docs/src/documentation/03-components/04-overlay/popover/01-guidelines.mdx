...
- For content that still might interest users and can be revealed through [progressive disclosure](/guides/progressive-disclosure/).
...
<ReactExample name="Popover trigger" />
...
<Guidelines type="do" title="Focus actions">
