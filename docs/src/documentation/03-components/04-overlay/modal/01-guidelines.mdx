...
import { SIZES as ModalSizeConstants } from "@kiwicom/orbit-components/src/Modal/consts.js";
import Theme from "@kiwicom/orbit-components/lib/defaultTheme";

<ReactExample name="Modal" />
...
For example, if you have options to offer for each [segment](/content/glossary/#itinerary-parts) of a trip,
...
<ReactExample name="Modal with card" />
...
<Guidelines type="do" title="Mobile">
...
<Guidelines type="do" title="Desktop">
...
<table>
  ...
  <tbody>
    <tr>
      <td>{ModalSizeConstants.EXTRASMALL}</td>
      <td>360px</td>
    </tr>
    <tr>
      <td>{ModalSizeConstants.SMALL}</td>
      <td>{Theme.orbit.widthModalSmall}</td>
    </tr>
    <tr>
      <td>{ModalSizeConstants.NORMAL}</td>
      <td>{Theme.orbit.widthModalNormal}</td>
    </tr>
    <tr>
      <td>{ModalSizeConstants.LARGE}</td>
      <td>{Theme.orbit.widthModalLarge}</td>
    </tr>
    <tr>
      <td>{ModalSizeConstants.EXTRALARGE}</td>
      <td>{Theme.orbit.widthModalExtraLarge}</td>
    </tr>
  </tbody>
</table>

<ReactExample name="Modal sizes" />
