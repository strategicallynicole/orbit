...
<Guidelines type="do" title="Give a cancel option">
...
<Guidelines type="do" title="Warn about destructive actions">
...
<Guidelines type="do" title="Minimize information">
