...
<ReactExample name="Tooltip" />

## When to use

- To keep extra information off the screen but accessible (through [progressive disclosure](/guides/progressive-disclosure/)).
...
<FigmaFile
  ...
  node="230%3A95"
  alt="Close button: closes tooltip on mobile; content: adds static info for context or additional help; tooltip indicator: indicates when text is wrapped in a tooltip; arrow: points to child on desktop and optionally can be set with preferred position and alignment."
/>
...
<ReactExample name="Tooltip indication" />
...
<ReactExample name="Tooltip disabled" />
...
to continue the pattern of [progressive disclosure](/guides/progressive-disclosure/).
...
nd moving their mouse over it to learn more.
